...
public class ObserverRegistry {
  ...
  public void register(Object observer) {
    ...
    for (Entry<Class<?>, Collection<ObserverAction>> entry : observerActions
        .entrySet()) {
  ...
  public List<ObserverAction> getMatchedObserverActions(Object event) {
    ...
    for (Entry<Class<?>, CopyOnWriteArraySet<ObserverAction>> entry : registry
        .entrySet()) {
      Class<?> eventType = entry.getKey();
  ...
  private List<Method> getAnnotatedMethods(Class<?> clzz) {
